    ...
    <table cellpadding="0" align="center"
        ...
        <tr>
            <th valign="middle"
                ...
                <!--这个位置可以用动态替换，因为不止注册发送验证码，找回密码也需要发送验证码-->
        ...
        <tr>
            <td style="word-break:break-all">
                <div style="padding:25px 35px 40px; background-color:#fff;opacity:0.8;">
                    ...
                    <!-- 中文 -->
                    <p>您好！感谢您注册本系统，您的账号正在进行邮箱验证，验证码为：<font color="#ff8c00">{0}</font>，有效期3分钟，请尽快填写验证码完成验证！
                    </p><br>
                    <!-- 英文 -->
                    <h2 style="margin: 5px 0px; ">
                        <font color="#333333" style="line-height: 20px; ">
                    ...
                    <p>Hello! Thanks for using *****, your account is being authenticated by email, the
                        verification code is:<font color="#ff8c00">{0}</font>, valid for 30 minutes. Please fill in the
